...
int main() {
	...
	sf::RenderWindow *window = new sf::RenderWindow(sf::VideoMode(cameraX, cameraY), "Level Designer");
	sf::View *camera = new sf::View(sf::Vector2f(cameraX / 2, cameraY / 2), sf::Vector2f(cameraX, cameraY));
